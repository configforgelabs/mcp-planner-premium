...
const SERVER_INSTRUCTIONS = [
  ...
  "5. Exact @odata.bind keys: msdyn_project, msdyn_projectbucket, msdyn_parenttask, msdyn_predecessortask, msdyn_successortask. NEVER msdyn_bucket / msdyn_projectbucketid / msdyn_parent / msdyn_parenttaskid. On a 'not a valid navigation property' error, use the corrected key the server names - do not retry the same payload.",
  ...
  "7. msdyn_ismilestone, msdyn_progress and actuals are rejected on create - set them in a follow-up update_tasks_batch session. Dependencies cannot be updated - delete and recreate.",
